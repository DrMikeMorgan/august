...
class Module
  ...
  void associateRecordID(std::string existingID, std::string newID){rows[getMap(newID)].insert(newID, rows[getMap(existingID)].get(existingID));} // exception framework 
